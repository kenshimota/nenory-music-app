...
import ToolbarIngredients from "./ToolbarIngredients";
import FooterPagination from "../../components/FooterPagination";
import ButtonCreateIngredient from "./ButtonCreateIngredient";
...
const Toolbar = styled(ToolbarIngredients)(({ theme }) => ({
    width: "100%",
    maxWidth: 600,
}));
...
const IngredientsScreen = () => {
    ...
    return (
        <MainPage title="Nenory Coffee" subtitle="Ingredientes" isBack>
            <GridRoot container spacing={1}>
                ...
                <GridFooter item xs={12}>
                    <FooterPagination
                        ...
                        onNext={() => setPage(page + 1)}
                    >
                        <ButtonCreateIngredient onSave={reload} />
                    </FooterPagination>
                </GridFooter>
            </GridRoot>
        </MainPage>
